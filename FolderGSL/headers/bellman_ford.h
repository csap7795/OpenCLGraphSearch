...
// in_cost is the cost array of any single source shortes path calculation like for example dijkstra
...
// The first one saves the acutal cycles, the second one the number of elements in the cycle
