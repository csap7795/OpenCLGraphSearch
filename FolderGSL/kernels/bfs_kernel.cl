...
void expand_bfs_SIMD(unsigned W_OFF,int cnt,__global unsigned* edges, __global unsigned* levels,__global unsigned* path, unsigned predecessor ,unsigned curr, __global bool* finished)
{
    for(int IDX = W_OFF;IDX<cnt;IDX+=W_SZ)
    {
...
__kernel void workgroup_bfs_kernel(__global unsigned *vertices, __global unsigned *edges, __global unsigned *levels,__global unsigned *path, __global bool *finished, unsigned curr)
{
...
__kernel void initialize_bfs_kernel(__global unsigned *levels,__global unsigned* path,__global bool *finished, unsigned src)
{
...
__kernel void baseline_kernel(__global unsigned *vertices, __global unsigned *edges, __global unsigned *levels,__global unsigned *path,__global bool* finished,  unsigned curr)
{
